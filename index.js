...
function parseOrder(content) {
    ...
    if (text.includes("big mac")) return "1";
    if (text.includes("nugget")) return "2";
    if (text.includes("fries") || text.includes("fry")) return "3";
    if (text.includes("mcflurry") || text.includes("mc flurry") || text.includes("flurry")) return "4";
    if (text.includes("mcchicken") || text.includes("mc chicken")) return "5";
    if (text.includes("happy meal")) return "6";
    if (text.includes("apple pie") || text.includes("pie")) return "7";
...
You have reached the highest loyalty tier.`;
    ...
    const itemNumber = parseOrder(message.content);
