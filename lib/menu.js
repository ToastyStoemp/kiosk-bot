const { hash, getVariant } = require("./utils");
...
function getMcFlurry(user) {
    ...
    const flavour = getVariant(user.id + "mcflurry-flavor", ["Oreo", "Smarties", "M&M's", "Crunchie"]);
...
module.exports = { prices, orderMessage, menu, hiddenMenu, parseOrder };
